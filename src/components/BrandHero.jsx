    ...
    <section className="relative overflow-hidden bg-[#f7f2ea]">
      <div className="relative min-h-[520px] md:min-h-[640px]">
        <img
          ...
          loading="eager"
        />
        <div className="absolute inset-0 bg-gradient-to-r from-[#1B1712]/80 via-[#1B1712]/50 to-transparent" />

        <div className="relative z-10 mx-auto flex min-h-[520px] md:min-h-[640px] max-w-7xl items-center px-6 py-16 sm:px-10 lg:px-16">
          <div className="max-w-xl">
            ...
            <div className="mt-6 flex flex-wrap gap-2 text-[11px] font-semibold uppercase tracking-[.12em] text-white/80">
