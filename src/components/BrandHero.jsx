  ...
  return (
    <section className="relative isolate overflow-hidden bg-[#f7f2ea]">
      <div className="relative min-h-[680px]">
        ...
        <div className="absolute inset-0 bg-[linear-gradient(90deg,rgba(7,18,16,0.72)_0%,rgba(7,18,16,0.5)_26%,rgba(7,18,16,0.18)_52%,rgba(7,18,16,0.12)_100%)]" />
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_right,rgba(184,117,60,0.25),transparent_28%)]" />

        <div className="relative z-10 mx-auto flex min-h-[680px] max-w-7xl items-center px-6 py-16 sm:px-10 lg:px-20">
          <div className="max-w-xl rounded-[2rem] border border-white/15 bg-[#173F34]/18 p-6 shadow-[0_24px_60px_rgba(10,19,17,0.25)] backdrop-blur-[1px] sm:p-8">
            ...
            <div className="mt-9 grid max-w-md grid-cols-2 gap-5 text-xs text-white/90">
              <div className="flex gap-3 rounded-2xl border border-white/15 bg-white/10 p-3"><Truck size={20} strokeWidth={1.75} className="shrink-0 text-[#f3d5ad]" /><div><strong className="block">Livraison rapide</strong><span>Partout au Sénégal & au Niger</span></div></div>
              <div className="flex gap-3 rounded-2xl border border-white/15 bg-white/10 p-3"><MapPin size={20} strokeWidth={1.75} className="shrink-0 text-[#f3d5ad]" /><div><strong className="block">Expédié depuis</strong><span>Dakar · Niamey</span></div></div>
            </div>
          </div>
        </div>
      </div>
