    ...
    if (this.state.error) {
      return (
        <div className="mx-auto max-w-xl px-5 py-24 text-center">
          ...
          <button type="button" onClick={() => window.location.reload()} className="mt-6 rounded-full bg-[#B8753C] px-6 py-3 text-sm font-bold text-white">Recharger la page</button>
        </div>
      );
    }
