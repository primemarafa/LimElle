...
const source = await fs.readFile(new URL("../LimElleSite.jsx", import.meta.url), "utf8");
...
test("frontend API client encodes order lookup references", () => {
  assert.match(apiClient, /encodeURIComponent\(reference\)/);
});
